...
class Timetable{
    ...
    public function addTimetable($code, $pid, $lid, $room, $slot, $version, $event){
        $this->db->query("INSERT INTO timetable(course_code, program_id, lecturer_id, room_id, slot_id, version_id, event_id) VALUES (:code, :pid, :lid, :room, :slot, :version, :event_id)");
